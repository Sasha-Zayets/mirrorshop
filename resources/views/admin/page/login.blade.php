<html>
    <head>
        ...
        <title>WMPanel | Log in</title>
        <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
        <link rel="stylesheet" href="{{ mix("/admin/css/login.css") }}">
    </head>
        ...
        <div id="back">
          ...
          <div id="slideBox">
            <div class="topLayer">
              ...
              <div class="right">
                <div class="content">
                <img src="/static/wm.svg" class="logo" alt="">
                  <h2>WMPanel</h2>
                  <form method="post" autocomplete="off">
                    {{ csrf_field() }}
                    <div class="form-element form-stack">
                      <label for="username-login" class="form-label">Ім’я користувача</label>
                      <input id="username-login" type="text" name="login" tabindex="1" autofocus>
                    </div>
                    <div class="form-element form-stack">
                      <label for="password-login" class="form-label">Пароль</label>
                      <input id="password-login" type="password" name="password" tabindex="2">
                    </div>
                    <div class="form-element form-submit">
                      <button class="login" type="submit" name="submit" tabindex="3">Увійти</button>
                    </div>
                  </form>

                  <div class="snackbar @if (session('loginFailed')) snackbar--active @endif">Невірно вказано ім'я користувача або пароль</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            setTimeout(function () {
                $('.snackbar--active').removeClass('snackbar--active');
            }, 3000);
        });
